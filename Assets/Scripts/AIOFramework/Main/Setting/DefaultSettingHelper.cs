...
namespace AIOFramework.Setting
{
    ...
    {
        private const string _settingFileName = "GameFrameworkSetting.dat";
        ...
        private void Awake()
        {
            _filePath = Utility.Path.GetRegularPath(Path.Combine(Application.persistentDataPath, _settingFileName));
