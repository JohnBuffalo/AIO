...
namespace AIOFramework.UI
{
    public interface IUIManager
    {
        ...
        /// <returns></returns>
        UniTask<int> OpenUI<TViewModel>(UICtorInfo ctorInfo) where TViewModel : UIViewModelBase, new();
        ...
        UniTask<int> OpenUI(UICtorInfo ctorInfo, UIViewModelBase viewModel);
